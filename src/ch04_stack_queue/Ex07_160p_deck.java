...
public class Ex07_160p_deck {
    ...
    // 생성자
    public Ex07_160p_deck(int capacity) {
        num = front = rear = 0;
        max = capacity;
        try {
    ...
    // 덱(deck)의 시작부터 데이터를 피크(처음 넣어진 데이터를 살펴봄)
    ...
    // 덱(deck)의 마지막부터 데이터를 피크(마지막 데이터를 살펴봄)
    ...
    // 덱(deck)에서 x를 검색하여 시작에서부터 몇 번 째인가를 반환
